const PROJECTS = [
  ...
  {
    completion: 25,
    description: "A iOS mobile application for keeping track of board games. Keep track of your board game stats and see how you compare to your friends.",
  ...
  {
    completion: 100,
    description: "A simple boiler plate generation tool. Create reuseable templates for your project and generate them with ease.",
  ...
  {
    completion: 90,
    description: "A simple list app that can be used for shopping lists, to-do lists, or any other list you can think of.",
